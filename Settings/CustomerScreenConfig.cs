...
namespace Resto.Front.Api.CustomerScreen.Settings
{
    ...
    public sealed class CustomerScreenConfig
    {
        ...
        private static CustomerScreenConfig Load()
        {
            ...
            config.SupportedExtensions.AddRange(new[] { "*.avi", "*.wmv", "*.mp4" });
            config.PathToPlaylistFolder = @"C:\Users\Adilkhan\Desktop\Video";
            config.LogoImagePath = @"C:\Users\Adilkhan\Downloads\bird-colorful-logo-gradient-vector\7.jpg";
